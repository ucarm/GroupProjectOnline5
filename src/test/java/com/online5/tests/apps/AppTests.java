...
public class AppTests extends TestBase {
  ...
  public void SPA_1072_searchAnAppName() {
    ...
    assertEquals(
        driver.getTitle(), "Free Calorie Counter, Diet & Exercise Journal | MyFitnessPal.com");
    extentLogger.pass(
        "Verified the website title: 'Free Calorie Counter, Diet & Exercise Journal | MyFitnessPal.com'");
    ...
    assertEquals(
        appsPage.appMarketPlaceTitle.getText(),
        "App Marketplace",
